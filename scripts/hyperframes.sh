...
# Rede: tres ajustes, cada um por um motivo diferente.
...
#  - o `fetch` nativo do Node NAO le HTTPS_PROXY sozinho; sem NODE_USE_ENV_PROXY=1 o
#    compilador do HyperFrames leva 403 ao baixar o GSAP do cdn.jsdelivr.net, mesmo
#    com o dominio liberado. Com a variavel, ele baixa e embute o script no bundle,
#    e ai o browser nao precisa mais sair para a internet no render.
#  - NODE_EXTRA_CA_CERTS faz o Node confiar na CA do proxy (TLS re-terminado nele).
