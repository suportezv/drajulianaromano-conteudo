#!/usr/bin/env bash
# Validação do estúdio de conteúdo (agnóstico de marca; só o bloco 7 cita a marca).
# Itens de MCP (Metricool, Kairogen) validam-se dentro da sessão do Claude, não aqui.
set -uo pipefail
...
echo " - Metricool: getBrandSettings lista a marca drajulianaromano com blog_id 6741531"
echo " - Kairogen: get_me_context mostra plano e créditos (conta suporte@zavi.ag; em 2026-08-18 FREE, 0 créditos)"
