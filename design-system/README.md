...
**Legado** (não usar em peças novas): petróleo do site atual (`#1F3642`, `#3B5E70`, `#6C8FA3`) e vinho do favicon (`#6F2848`). A nova identidade substitui.
...
- **Método Bella & Magra**, 3 pilares: Medicina Metabólica, Remodelação Estética, Código do Inconsciente. Instituto Romano.
- Público: mulheres 40+. Tom: autoridade médica que acolhe; provocação elegante, sem terrorismo.
