...
Estúdio de edição e agendamento de conteúdo para as redes da **Dra. Juliana Romano**. Estúdio irmão do [`ana-conteudo`](https://github.com/suportezv/ana-conteudo) e do [`eita-conteudo`](https://github.com/suportezv/eita-conteudo); mesma infraestrutura, posicionamento desta marca.
...
| Metricool | Agendamento | Conectar a marca da Dra. Juliana Romano (pendente) |
